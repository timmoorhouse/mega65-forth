...
DOUBLE | [`2CONSTANT`](https://forth-standard.org/standard/double/TwoCONSTANT) [`2LITERAL`](https://forth-standard.org/standard/double/TwoLITERAL) [`D+`](https://forth-standard.org/standard/double/DPlus) [`D-`](https://forth-standard.org/standard/double/DMinus) [`D.`](https://forth-standard.org/standard/double/Dd) [`D.R`](https://forth-standard.org/standard/double/DDotR) [`D0<`](https://forth-standard.org/standard/double/DZeroless) [`D0=`](https://forth-standard.org/standard/double/DZeroEqual) [`D2*`](https://forth-standard.org/standard/double/DTwoTimes) [`D2/`](https://forth-standard.org/standard/double/DTwoDiv) [`D<`](https://forth-standard.org/standard/double/Dless) [`D=`](https://forth-standard.org/standard/double/DEqual) [`D>S`](https://forth-standard.org/standard/double/DtoS) [`DABS`](https://forth-standard.org/standard/double/DABS) [`DMAX`](https://forth-standard.org/standard/double/DMAX) [`DMIN`](https://forth-standard.org/standard/double/DMIN) [`DNEGATE`](https://forth-standard.org/standard/double/DNEGATE) | [`2VARIABLE`](https://forth-standard.org/standard/double/TwoVARIABLE) [`M*/`](https://forth-standard.org/standard/double/MTimesDiv) [`M+`](https://forth-standard.org/standard/double/MPlus)
