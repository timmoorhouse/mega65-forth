...
- CORE-EXT
- DOUBLE
  - [ ] Need to support double literals (eg `123.`).[^alpha]
- EXCEPTION
...
- Error checking (and throwing the appropriate exception)
  ...
  - [ ] Return stack imbalance.[^alpha]
  - [ ] User interrupt.[^alpha]
  - [ ] Invalid name.
  - [ ] Non-existent file.[^alpha]
  - [ ] File I/O error.[^alpha]
  - [ ] Unexpected EOF.
...
- Other release preparation
  - [ ] Write a bit of a getting started guide.[^alpha]
  - [ ] Find or write a few example programs.[^alpha]
...
FILE-EXT | [`INCLUDE`](https://forth-standard.org/standard/file/INCLUDE) | [`FILE-STATUS`](https://forth-standard.org/standard/file/FILE-STATUS) [`FLUSH-FILE`](https://forth-standard.org/standard/file/FLUSH-FILE) [`RENAME-FILE`](https://forth-standard.org/standard/file/RENAME-FILE)[^alpha] [`REQUIRE`](https://forth-standard.org/standard/file/REQUIRE) [`REQUIRED`](https://forth-standard.org/standard/file/REQUIRED)
...
[^alpha]: Should be done for the first alpha release
