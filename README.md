...
[CORE-EXT](https://github.com/gerryjackson/forth2012-test-suite/blob/master/src/coreexttest.fth) | **FAIL** | 7 errors reported, 3 of which are expected[^petscii].  Some things still to implement (`MARKER` in particular).
